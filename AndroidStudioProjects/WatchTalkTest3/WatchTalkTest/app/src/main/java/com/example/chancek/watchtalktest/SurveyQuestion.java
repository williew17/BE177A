...
// setContentView(R.layout.activity_scrollviewoptions);
...
// Load scrollview with optionsArray

    public void LoadScrollView(ArrayList optionsArray){
...
getQuestions(gtoken,responseID,valueID);*/
    ...
    public void callExitPage(String dateFinished){
        ...
        intent.putExtra("assessmentID", gtoken);
        intent.putExtra("totalToken", totalToken);
